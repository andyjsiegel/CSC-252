public class Test_extraInst_XORI {
    public static void main(String[] args) {
        ...
        // xori  $s4, $s0, -1
        // xori  $s5, $s1, 0x5678
        cpuState.instMemory[0x102] = sim4_test_commonCode.XORI(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), -1);
        cpuState.instMemory[0x103] = sim4_test_commonCode.XORI(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), 0x5678);
