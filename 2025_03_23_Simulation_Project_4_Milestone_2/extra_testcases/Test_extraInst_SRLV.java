public class Test_extraInst_SRLV {
    public static void main(String[] args) {
        ...
        // Encode constants into registers
        // addi  $s2, $zero, 12
        // addi  $s3, $zero, 1
        cpuState.instMemory[0x0fe] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(2), sim4_test_commonCode.REG_ZERO, 12);
        cpuState.instMemory[0x0ff] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(3), sim4_test_commonCode.REG_ZERO, 1);

        // addi  $s0, $zero, -12345
        // addi  $s1, $zero, 1000
        cpuState.instMemory[0x100] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(0), sim4_test_commonCode.REG_ZERO, -12345);
        cpuState.instMemory[0x101] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(1), sim4_test_commonCode.REG_ZERO, 1000);

        // srlv $s4, $s0, $s2
        // srlv $s5, $s1, $s3
        cpuState.instMemory[0x102] = sim4_test_commonCode.SRLV(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), sim4_test_commonCode.S_REG(2));
        cpuState.instMemory[0x103] = sim4_test_commonCode.SRLV(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), sim4_test_commonCode.S_REG(3));
