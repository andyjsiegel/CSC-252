public class Test_extraInst_SLL {
    public static void main(String[] args) {
        ...
        // sll  $s4, $s0, 12
        // sll  $s5, $s1, 1
        cpuState.instMemory[0x102] = sim4_test_commonCode.SLL(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), 12);
        cpuState.instMemory[0x103] = sim4_test_commonCode.SLL(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), 1);
