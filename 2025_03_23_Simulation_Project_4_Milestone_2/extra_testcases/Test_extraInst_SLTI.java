public class Test_extraInst_SLTI {
    public static void main(String[] args) {
        ...
        // addi  $s0, $zero, 0x2468
        // addi  $s1, $zero, 0x3579
        cpuState.instMemory[0x100] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(0), sim4_test_commonCode.REG_ZERO, 0x2468);
        cpuState.instMemory[0x101] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(1), sim4_test_commonCode.REG_ZERO, 0x3579);

        // slti  $s4, $s0, 0x7c55
        // slti  $s5, $s1, 0x1234
        cpuState.instMemory[0x102] = sim4_test_commonCode.SLTI(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), 0x7c55);
        cpuState.instMemory[0x103] = sim4_test_commonCode.SLTI(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), 0x1234);
