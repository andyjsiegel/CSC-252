public class Test_extraInst_DIV_MFHI {
    public static void main(String[] args) {
        ...
        // Print remaining values with newlines in between
        // ...many more print instructions omitted for brevity...

        // div   $s0,$s1
        // mfhi  $t0
        cpuState.instMemory[0x13e] = sim4_test_commonCode.DIV(sim4_test_commonCode.S_REG(0), sim4_test_commonCode.S_REG(1));
        cpuState.instMemory[0x13f] = sim4_test_commonCode.MFHI(sim4_test_commonCode.T_REG(0));

        // div   $s2,$s3
        // mfhi  $t1
        cpuState.instMemory[0x140] = sim4_test_commonCode.DIV(sim4_test_commonCode.S_REG(2), sim4_test_commonCode.S_REG(3));
