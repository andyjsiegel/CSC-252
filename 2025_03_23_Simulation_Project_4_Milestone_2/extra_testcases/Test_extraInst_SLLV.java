public class Test_extraInst_SLLV {
    public static void main(String[] args) {
        ...
        // sllv  $s4, $s0, $s2
        // sllv  $s5, $s1, $s3
        cpuState.instMemory[0x102] = sim4_test_commonCode.SLLV(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), sim4_test_commonCode.S_REG(2));
        cpuState.instMemory[0x103] = sim4_test_commonCode.SLLV(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), sim4_test_commonCode.S_REG(3));
