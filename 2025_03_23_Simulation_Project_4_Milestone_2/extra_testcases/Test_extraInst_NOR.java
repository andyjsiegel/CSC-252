public class Test_extraInst_NOR {
    public static void main(String[] args) {
        ...
        cpuState.instMemory[0x102] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(2), sim4_test_commonCode.REG_ZERO, -1);
        cpuState.instMemory[0x103] = sim4_test_commonCode.ADDI(sim4_test_commonCode.S_REG(3), sim4_test_commonCode.REG_ZERO, 0x5678);

        // nor  $s4, $s0, $s2
        // nor  $s5, $s1, $s3
        cpuState.instMemory[0x104] = sim4_test_commonCode.NOR(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), sim4_test_commonCode.S_REG(2));
        cpuState.instMemory[0x105] = sim4_test_commonCode.NOR(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), sim4_test_commonCode.S_REG(3));
