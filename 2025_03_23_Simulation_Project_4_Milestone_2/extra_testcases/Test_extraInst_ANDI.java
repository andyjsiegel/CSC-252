public class Test_extraInst_ANDI {
    public static void main(String[] args) {
        ...
        // andi  $s4, $s0, 0xcc55
        // andi  $s5, $s1, 0x1200
        cpuState.instMemory[0x102] = sim4_test_commonCode.ANDI(sim4_test_commonCode.S_REG(4), sim4_test_commonCode.S_REG(0), 0xcc55);
        cpuState.instMemory[0x103] = sim4_test_commonCode.ANDI(sim4_test_commonCode.S_REG(5), sim4_test_commonCode.S_REG(1), 0x1234);
