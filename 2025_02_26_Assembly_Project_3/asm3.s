# Assembly Project 3 - CSC 252 Spring 2025
# Author: Andy Siegel
# This project implements 5 functions: strlen(), gcf(), bottles(), rotate(), and longestSorted().
# No functions are tied together. gcf is recursive.
...
# int strlen(char *str) {
#    int i = 0; // length initialized to 0
#    while (str[i] != '\0') { // while character is not null terminator, increment i (the length)
#        i++;
#    }
...
# int longestSorted(int* array, int length) {
#     int max_run = 1;  
#     int current_run = 1; 
#     int i = 1;  
# 
...
#     }
# 
#     while (i < length) {  // Loop until i >= length
#         int t3 = array[i];      
#         int t4 = array[i - 1]; 
# 
